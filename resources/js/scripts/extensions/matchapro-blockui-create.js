...
$(function () {
    ...
    var section = $('.section-block-cek_data_table'),
      sectionBlock = $('.btn-step1'),
    ...
    if (sectionBlock.length && section.length) {
      // section.block({
      //   message:
      //     '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Mohon Menunggu...</p><div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
      //   timeout: 10000,
      //   css: {
      ...
      section.block({
        message: '<p class="me-50 mb-0">Mohon Menunggu...</p><div class="spinner-grow spinner-grow-sm text-white" role="status"></div>',
        timeout: 10000,
        css: {
          backgroundColor: 'transparent',
          color: '#fff',
        ...
        centerY: true,  // Ensures vertical centering
      });
