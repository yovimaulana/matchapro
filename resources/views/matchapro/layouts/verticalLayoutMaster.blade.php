<body
    ...
    <!-- BEGIN: Header-->
    @include('matchapro.panels.navbar')
    <!-- END: Header-->

    <!-- BEGIN: Main Menu-->
    @if (isset($configData['showMenu']) && $configData['showMenu'] === true)
        @include('matchapro.panels.sidebar')
    @endif
    <!-- END: Main Menu-->
        ...
        @else
            <div class="content-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}">
                ...
                @if ($configData['pageHeader'] === true && isset($configData['pageHeader']))
                    @include('matchapro.panels.breadcrumb')
                @endif
    ...
    {{-- include footer --}}
    @include('matchapro/panels/footer')

    {{-- include default scripts --}}
    @include('matchapro/panels/scripts')
